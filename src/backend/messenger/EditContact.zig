...
pub const Messenger = struct {
    ...
    pub fn receiveEditContactFn(implementor: *anyopaque, message: *_message_.EditContact.Message) anyerror!void {
    ...
    fn receiveJob(self: *Messenger, message: *_message_.EditContact.Message) !void {
