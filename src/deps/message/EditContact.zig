...
/// This file will be removed by kickzig if you remove the "EditContact" message.
/// The "EditContact" message is:
...
const Contact = @import("record").Edit;
const Counter = @import("counter").Counter;
const ScreenTags = @import("framers").ScreenTags;

// FrontendPayload is the "EditContact" message from the front-end to the back-end.
...
pub const FrontendPayload = struct {
    ...
    pub fn set(self: *FrontendPayload, values: Settings) !void {
        if (self.is_set) {
            return error.EditContactFrontendPayloadAlreadySet;
        }
        self.is_set = true;
...
// BackendPayload is the "EditContact" message from the back-end to the front-end.
...
pub const BackendPayload = struct {
    ...
    pub fn set(self: *BackendPayload, values: Settings) !void {
        if (self.is_set) {
            return error.EditContactBackendPayloadAlreadySet;
        }
        self.is_set = true;
...
/// This is the "EditContact" message.
pub const Message = struct {
    ...
    /// self.send_channels.EditContact.send(message) catch |err| {
