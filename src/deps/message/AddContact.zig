...
/// This file will be removed by kickzig if you remove the "AddContact" message.
/// The "AddContact" message is:
...
// BackendPayload is the "AddContact" message from the back-end to the front-end.
...
/// This is the "AddContact" message.
pub const Message = struct {
    ...
    /// self.send_channels.AddContact.send(message) catch |err| {
