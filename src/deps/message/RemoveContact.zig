...
/// This file will be removed by kickzig if you remove the "RemoveContact" message.
/// The "RemoveContact" message is:
...
// BackendPayload is the "RemoveContact" message from the back-end to the front-end.
...
/// This is the "RemoveContact" message.
pub const Message = struct {
    ...
    /// self.send_channels.RemoveContact.send(message) catch |err| {
