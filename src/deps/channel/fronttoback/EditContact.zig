...
/// 1. Any front-end messenger can send a "EditContact" message to the subscribed back-end messengers.
/// 2. Every subscribed back-end messenger receives a copy of each "EditContact" message sent from the front-end.
...
pub const _message_ = @import("message").EditContact;
const ExitFn = @import("various").ExitFn;

/// Behavior is call-backs and state.
/// .implementor implements the recieveFn.
/// .receiveFn receives a EditContact message from the back-end.
