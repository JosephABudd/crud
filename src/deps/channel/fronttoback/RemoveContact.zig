...
/// 1. Any front-end messenger can send a "RemoveContact" message to the subscribed back-end messengers.
/// 2. Every subscribed back-end messenger receives a copy of each "RemoveContact" message sent from the front-end.
...
/// .receiveFn receives a RemoveContact message from the back-end.
