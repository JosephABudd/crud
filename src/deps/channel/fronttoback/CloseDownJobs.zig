...
/// 1. Any front-end messenger can send a "CloseDownJobs" message to the subscribed back-end messengers.
/// 2. Every subscribed back-end messenger receives a copy of each "CloseDownJobs" message sent from the front-end.
...
/// .receiveFn receives a CloseDownJobs message from the back-end.
...
pub const Group = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, dispatcher: *GeneralDispatcher, exit: ExitFn) !*Group {
        ...
        dispatcher.CloseDownJobs = channel;
        return channel;
    }
