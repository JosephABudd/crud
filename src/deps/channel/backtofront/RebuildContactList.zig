...
/// 1. Any back-end messenger can send a "RebuildContactList" message to the subscribed front-end messengers.
/// 2. Every subscribed front-end messenger receives a copy of each "RebuildContactList" message sent from the back-end.
...
pub const Message = @import("message").RebuildContactList;

/// Behavior is call-backs and state.
/// .implementor implements the recieveFn.
/// .receiveFn receives a RebuildContactList message from the front-end.
...
pub const Group = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, dispatcher: *GeneralDispatcher, exit: ExitFn) !*Group {
        ...
        dispatcher.RebuildContactList = channel;
        return channel;
    }
