...
/// 1. Any back-end messenger can send a "RemoveContact" message to the subscribed front-end messengers.
/// 2. Every subscribed front-end messenger receives a copy of each "RemoveContact" message sent from the back-end.
/// This file was generated by kickzig when you added the "RemoveContact" message.
/// It will be removed when you remove the "RemoveContact" message.

const std = @import("std");
const GeneralDispatcher = @import("general_dispatcher.zig").GeneralDispatcher;

const ExitFn = @import("various").ExitFn;
pub const Message = @import("message").RemoveContact;

/// Behavior is call-backs and state.
/// .implementor implements the recieveFn.
/// .receiveFn receives a RemoveContact message from the front-end.
...
pub const Group = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, dispatcher: *GeneralDispatcher, exit: ExitFn) !*Group {
        ...
        dispatcher.RemoveContact = channel;
        return channel;
    }
