...
/// 1. Any back-end messenger can send a "AddContact" message to the subscribed front-end messengers.
/// 2. Every subscribed front-end messenger receives a copy of each "AddContact" message sent from the back-end.
...
pub const _message_ = @import("message").AddContact;
const ExitFn = @import("various").ExitFn;

/// Behavior is call-backs and state.
/// .implementor implements the recieveFn.
/// .receiveFn receives a AddContact message from the front-end.
